...
/// A class that contains all theme configurations for the wellness habit tracking application.
class AppTheme {
  AppTheme._();

  // Wellness-focused color palette
  static const Color primaryLight = Color(0xFF2D5A87); // Deep wellness blue
  static const Color primaryVariantLight = Color(0xFF1E3A5F);
  static const Color secondaryLight = Color(0xFF7FB069); // Natural growth green
  static const Color secondaryVariantLight = Color(0xFF5A8A47);
  static const Color accentLight = Color(0xFFF4A261); // Warm achievement orange
  static const Color backgroundLight = Color(0xFFFAFBFC); // Soft off-white
  static const Color surfaceLight = Color(0xFFFFFFFF); // Pure white
  static const Color errorLight = Color(0xFFE76F51); // Muted coral red
  static const Color warningLight = Color(0xFFE9C46A); // Gentle amber
  static const Color successLight = Color(0xFF264653); // Deep forest green
  ...
  static const Color borderLight = Color(0xFFE5E7EB); // Minimal border gray

  // Dark theme colors (adapted for wellness context)
  static const Color primaryDark = Color(0xFF5A8BC4);
  static const Color primaryVariantDark = Color(0xFF2D5A87);
  static const Color secondaryDark = Color(0xFF9BC985);
  ...
  static const Color successDark = Color(0xFF4A7C59);
  ...
  // Shadow colors with wellness-appropriate opacity
  ...
  /// Light theme optimized for wellness and habit tracking
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme for wellness context
    ...
    // Bottom navigation optimized for habit tracking
    ...
    // Button themes with wellness-focused styling
    ...
    // Input decoration for habit tracking forms
    ...
    // Progress indicator for habit streaks
  ...
  /// Dark theme optimized for wellness and habit tracking
  ...
  /// Custom gradient for progress visualization
  ...
  /// Custom box shadow for cards with wellness-appropriate elevation
